    ...
    <div class="roles-permissions">
        ...
        <div class="mt-8 bg-white rounded border-b-4 border-gray-300">
            <div
                ...
                <div class="w-1/12 px-4 py-3">PID</div>
                <div class="w-2/12 px-4 py-3">Email</div>
                <div class="w-1/12 px-4 py-3 text-center">Children</div>
            ...
            @foreach ($parents as $parent)
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    ...
                    <div class="w-1/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight text-center">
                        {{ $parent->children_count }}</div>
                    <div class="w-2/12 px-4 py-3 text-sm font-semibold text-gray-600 tracking-tight">
                        {{ $parent->user->phone }}</div>
                    <div class="w-2/12 flex items-center justify-end px-3">
                        ...
                        <a href="{{ route('parents.edit', $parent->id) }}">
                            <svg class="ml-1 h-6 w-6 fill-current text-green-600" aria-hidden="true" focusable="false"
